...
class StrangeeProfileViewModelFactory(private val token: String, private val userId: String) : ViewModelProvider.Factory {
    @Suppress("unchecked_cast")
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(StrangeeProfileViewModel::class.java)) {
            return StrangeeProfileViewModel(token, userId) as T
        }
